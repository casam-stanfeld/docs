...
#### 2.4 Make sure that the file is correctly formatted like this:
```
email,user_id,given_name,family_name,provider
"test-user@test-email.com","auth0|012345678910111213141516","","","development-database"
```
